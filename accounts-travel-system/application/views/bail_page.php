  ...
  <div class="card">
    <form>
      ...
      <h5 style= "text-align :center"> <!--<b> Personal Details</b> --></h5>
          ...
          <div class="col-md-6">
          <div class="mb-3">
            <label for="exampleInput5" class="form-label"><b>Date Received</b></label>
        ...
        <div class="row">
          ...
          <label for="exampleInput4" class="form-label"><b>Reason for Return </b></label>
              <input type="text" class="form-control" id="reason_returned" name="reason_returned" disabled value="<?php echo set_value('reason_returned') ?>" placeholder="">
          </div>
          ...
          <input class="form-check-input" type="checkbox" id="returned" name="returned" value="yes" onchange="val()">
