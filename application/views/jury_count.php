...
<div class="container" id = "report_to_print">
    ...
    <br>
	<h5>Jury Claims Report for the month of : <span style="color: red;"><?php echo date("F Y",strtotime($month[0]));?> </span> </h5> </h5>
    <br>
  <?php 
      ...
      <div class="row">
        ...
        <thead class="thead-dark">
              <tr class="table-primary">
                  <th scope="col"> Number of Jury Claims Processed </th> 
