...
?>
        ...
        <h4 > Update Staff Details for Changes: </h4>
                <div class="col-md-4 col-md-offset-4">
                    ...
                    <div class="col-sm-10">
                        <input type="date" class="form-control-lg" name="date_of_change_end" value="<?php echo  (isset($changes)) ? substr($changes['dateof_change_end'],0,10) : ''; ?>" placeholder="">
                        </div>
                    </div>
                   ...
                   <select  class="form-control-lg" name="upkeepchange_type" id="upkeepchange_type">
                    ...
                    <div class="col-sm-10">
                        <input type="text" class="form-control-lg" name="monthly_allotment" value="<?php if(isset($_POST['monthly_allotment'])) {echo $_POST['monthly_allotment'];}elseif (isset($changes)){echo $changes['monthly_allotment'];}?>" placeholder="">
                        </div>
                    </div>
                    ...
                    <div class="col-sm-10">
                        <input type="text" class="form-control-lg" name="arrears" value="<?php if(isset($_POST['arrears'])) {echo $_POST['arrears'];}elseif (isset($changes)){echo $changes['arrears'];}?>" placeholder="">
                        </div>
                    </div>
                    ...
                    <div class="col-sm-10">
                        <input type="text" class="form-control-lg" name="changes_remarks" value="<?php if(isset($_POST['changes_remarks'])) {echo $_POST['changes_remarks'];}elseif (isset($changes)){echo $changes['changes_remarks'];}?>" placeholder="">
                        </div>
                    </div>

                    <br>
                    <div class="col-sm-10">
                   <button type="submit" class="btn btn-primary btn-block" value = "<?php  echo (isset($changes)) ? 'update':'submit';?>" name = "changes"> Submit </button> 
                    </div>
                    <hr>
